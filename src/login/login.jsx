        ...
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section className="relative flex h-32 items-end bg-blue-900 lg:col-span-5 lg:h-full xl:col-span-6">
            ...
            <div className="hidden lg:relative lg:block lg:p-12">
              ...
              <h2 className="mt-6 text-2xl font-bold text-gray-600 sm:text-3xl md:text-4xl">
              ...
              <form action="#" className="mt-8 grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    id="Email"
                    name="email"
                    className="p-3 w-full rounded-md border-gray-300 bg-white text-sm text-gray-700 shadow-lg"
                  />
                </div>
